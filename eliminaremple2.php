...
<br><table width="400" border="8" bordercolor="#CCCCCC">
        <tr><td><strong>Cedula:</strong></td><td><?php echo "  $row[0]" ?></td></tr>
        <tr>
          <td><strong>Nombre</strong><strong>del empleado:</strong></td>
        ...
        <tr><td><strong>Fecha:</strong></td><td><?php echo "  $row[7]" ?></td></tr>
