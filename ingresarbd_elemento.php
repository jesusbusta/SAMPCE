...
//tomo el valor de un elemento de tipo texto del formulario "$num_reg"
 $nombre_archivo2 = $nombre_elemento.".jpeg";
//datos del arhivo
...
// funcion para insertar los ddatos en la tabla informe_personal
             $Insertar= "INSERT INTO elemento_equipo VALUES('$cod_elemento','$nombre_elemento','$descripcion','$ruta','$titulo')";
