...
<?php 
   ...
   $descripcion_ubi=$_POST['descripcion_ubi']; 
    
  //COLOCA CONTENIDO EN MAYUSCULA
$id_dpto=strtoupper($id_dpto);
$nombre_ubi=strtoupper($nombre_ubi);
$descripcion_ubi=strtoupper($descripcion_ubi);



         mysql_query("insert into ubicaciones (id_dpto, nombre_ubi,descripcion_ubi) values ('$id_dpto','$nombre_ubi','$descripcion_ubi')",$link); 
