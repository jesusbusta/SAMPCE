...
//$horario=strtoupper($horario);
			...
			$Insertar= "UPDATE equipo SET  codigo_equipo='$codigo_equipo',nombre_equipo='$nombre_equipo',modelo='$modelo',marca='$marca',descripcion='$descripcion',fecha_ingreso='$fecha_ingreso',cantidad='$cantidad',estado='$estado' WHERE codigo_equipo ='$codigo_equipo' ";
