...
$foto=strtoupper($foto);
         ...
         mysql_query("insert into equipos (codigo_equipo, nombre_equipo, modelo, marca, descripcion, fecha_ingreso, cantidad, estado, foto) values ('$codigo_equipo','$nombre_equipo','$modelo','$marca','$descripcion','$fecha_ingreso','$cantidad','$estado','$foto')",$link); 
