...
<table width="200" border="3" align="center" cellpadding="2" cellspacing="1">
  <tr>
    <td width="82"><span class="Estilo1">Serial </span></td>
    <td width="97"><div align="center" class="Estilo1">Nombre</div></td>
  </tr>
</table>
<form action="consultacriterio_equipo2.php" method="post" name="form1" id="form1">
