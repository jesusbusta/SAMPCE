...
//tomo el valor de un elemento de tipo texto del formulario "$num_reg"
 $nombre_archivo2 = $nombre_empleado.".jpeg";
//datos del arhivo
...
// funcion para insertar los ddatos en la tabla informe_personal
             $Insertar= "INSERT INTO empleado VALUES('$ci','$nombre_empleado','$apellido','$cargo','$tlf','$direccion','$sexo','$horario','$ruta','$titulo')";
