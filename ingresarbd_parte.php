...
<?php 
   ...
   //tomar las variables  
   $codigo_parte_elemento=$_POST['codigo_parte_elemento'];
...
$codigo_parte_elemento=strtoupper($codigo_parte_elemento);
$nombre_parte=strtoupper($nombre_parte);
$dimensiones=strtoupper($dimensiones);
$material=strtoupper($material);


         mysql_query("insert into parte_elemento (codigo_parte_elemento, nombre_parte,dimensiones, material) values ('$codigo_parte_elemento','$nombre_parte','$dimensiones', '$material')",$link); 

	echo "Los Datos fueron almacenados exitosamente";
	echo "<br>"; echo "<br>";
