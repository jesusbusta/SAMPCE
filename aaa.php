...
<form id="form2" name="form2" method="post" action="ingresarbd_equipo.php">
     <table border="0" width="772" bgcolor="#BDBDBD">
      <tr>
        <td align="center" width="80"><strong>Serial</strong></td>
	  ...
	  <tr>
        <td align="center" width="80"><strong>Modelo</strong></td>
        <td><input name="modelo" type="text" id="modelo" /></td>
		<td><div align="center" width="80" class="Estilo2">Marca</div></td>
        <td><input name="marca" type="text" id="marca" /></td>
	  </tr>

<td><div align="center" width="80" class="Estilo2">descripcion</div></td>
        <td><input name="descripcion" type="text" id="descripcion" /></td>
		 
		 <td><div class="Estilo2" width="80">Fecha de ingreso</div></td>
	  ...
	  <td><div align="center" class="Estilo2">Cantidad</div></td>
       ...
       <td><div align="center" class="Estilo2">Estado actual</div></td>
