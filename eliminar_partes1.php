...
<form action="eliminar_parte2.php" method="post" name="form1" id="form1">
<div align="center">
<table width="200" bgcolor="#BDBDBD" border="1" bordercolor="#FFFFFF">
<tr>
  <td width="80"><div align="center"><strong>Codigo de la pieza</strong></div></td>
  <td><div align="center">
    <input type="text" size="10" name="cod_elemento" id="cod_elemento">
  </div></td>
</tr>
</table>
<br>
