<?php
	...
	$consulta="SELECT * FROM brueba LIMIT $desde, $hasta";
...
/*
 ...
 <?PHP
 $consulta="select count(a) from brueba";

		//$consulta="select count(id_equipo) from equipo";
...

		{
			...
			echo "<a href=\"consulta_equipo.php?pag=1\">|<<</a> <a href=\"pagina1.php?pag=".($pag-1)."\"></a> | ";

		}

		echo "<a href=\"consulta_equipo.php\">Volver</a> | ";
