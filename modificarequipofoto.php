...
$resultado = mysql_query ("SELECT titulo, archivo FROM equipo  WHERE $codigo_equipo=codigo_equipo", $enlace);
...
if (!$resultado)
{
	...
	exit;
        ...
        echo "";
			 ...
			 $resultado = mysql_query ("UPDATE equipo SET titulo='', archivo='' WHERE $codigo_equipo=codigo_equipo", $enlace);
...
<form method="post" name="form1" id="form1" enctype="multipart/form-data" action="modificarequipofoto2.php">
...
<input type="hidden" name="codigo_equipo" id="codigo_equipo" value="<?php 
$codigo_equipo=$_REQUEST['codigo_equipo'];
echo $codigo_equipo?>">
</center>
</form>							  
