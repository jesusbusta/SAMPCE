...
// $enlace se iguala a la funcion cenectarbase()
   ...
   $consulta = "SELECT * from elementos_equipo where cod_elemento = '$cod_elemento';";
                   ...
                   echo "<center><br><br><strong><center>la pieza con el codigo $cod_elemento no existe.</center></strong><br></br><br></br></center>";
                   }else
                   {
...
<table width="400" border="8" bordercolor="#CCCCCC" align="center">
        ...
        <tr><td><strong>Fotografia:</strong></td><td><?php echo "<a ><img src='$row[5]' width='120'height='100'></a>" ?></td></tr><br /> </table>     
...
<br>
<tr><td colspan="2"><center><br><input type="hidden" name="cod_elemento" id="cod_elemento" value="<?php echo $cod_elemento ?>"><input name="submit" type="submit" value="Continuar"></center></td></tr>
