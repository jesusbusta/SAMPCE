...
$elemento=strtoupper($elemento);
			...
			$Insertar= "UPDATE odt SET codigo_odt='$codigo_odt',empleado='$empleado',fecha_inicio='$fecha_inicio',fecha_final='$fecha_final',tipodemantenimiento='$tipodemantenimiento',equipo='$equipo',elemento='$elemento' WHERE codigo_odt = '$codigo_odt' ";
