...
<?php include "menu.php" ?>
  <label>
  <div align="center"><br />
      <span class="Estilo2">Partes de Elementos </span><br />
    <br />
    <br />
  </div>
  </label>
  <div align="center">
<form id="form2" name="form2" method="post" action="ingresarbd_parte.php">
 <table width="772" border="0" align="center" bgcolor="#BDBDBD">
      <tr>
        <td align="center" width="80"><strong>Serial del elemento</strong></td>
        <td><input name="codigo_parte_elemento" type="text" id="codigo_parte_elemento" /></td>
     <td align="center" width="80"><strong>Nombre</strong></td>
     
        <td><input name="nombre_parte" type="text" id="nombre_parte" /></td>
		
	  </tr>
	  
		<td align="center" width="80"><strong>Dimensiones</strong></td>
        <td><input name="dimensiones" type="text" id="dimensiones" /></td>
	  <td align="center" width="80"><strong>Material</strong></td>
