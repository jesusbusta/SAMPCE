...
// consulta a la tabla informe_personal	
	$consulta="SELECT * FROM odt where match (codigo_odt,empleado,equipo) against ('$criterio*' IN BOOLEAN MODE)";
		...
		while ($row = mysql_fetch_row($resultado))
    {
       //$link2 =$row[9];
		...
		//echo "<td><a target=_blank href='$link2'><img src='$row[9]' width='120'height='100'></a></td></tr>";
       	echo "<tr><td>Empleado: $row[1]</td>";
		//echo "<td>Fecha de inicio:      $row[2]</td></tr>";
		//echo "<tr ><td> fecha de final: $row[3]</td>";
		echo "<td>Tipo de mantenimiento: $row[4]</td><tr >";
       	echo "<tr><td>Equipo: $row[5]</td>";
       	echo "<td>elemento: $row[6]</td><tr>";
