...
<body>
 ...
 <form method="post" name="form1" id="form1" enctype="multipart/form-data" action="herramienta2.php" onsubmit="return validar()">
<br>   
 
<p align="center" class="Estilo3"><strong>herramienta</strong> 
...
<div align="center"><br>
    ...
    <table  width="772" bgcolor="#FFA500" align="center" border="1" bordercolor="#FFA500">
      <tr>
        <td width="252"><div align="center"><strong>Codigo</strong></div></td>
        <td width="235"><label>
          <div align="center">
