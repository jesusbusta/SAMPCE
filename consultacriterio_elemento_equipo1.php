...
<br>
<br><br>
<p align="center" class="Estilo1"> Consulta</p>
<table width="200" border="3" align="center" cellpadding="2" cellspacing="1">
  <tr>
    <td width="82"><span class="Estilo1">Nombre</span></td>
    <td width="97"><div align="center"><span class="Estilo1">Equipo</span></div></td>
  </tr>
</table>
<form action="consultacriterio_elemento_equipo2.php" method="post" name="form1" id="form1">
  <table width="250" border="9" align="center" bordercolor="#999999" bgcolor="#BDBDBD">
<tr>
  <td width="98"><strong>Busqueda Personalizada </strong></td>
