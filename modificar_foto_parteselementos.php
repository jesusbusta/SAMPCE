...
// $enlace se iguala a la funcion cenectarbase()
	$cod_elemento=$_REQUEST['cod_elemento'];  	
...
$resultado = mysql_query ("SELECT titulo, archivo FROM elementos_equipo  WHERE $cod_elemento=cod_elemento", $enlace);
...
if (!$resultado)
{
	...
	exit;
        ...
        echo "";
			 ...
			 $resultado = mysql_query ("UPDATE elementos_equipo SET titulo='', archivo='' WHERE $cod_elemento=cod_elemento", $enlace);
...
<form method="post" name="form1" id="form1" enctype="multipart/form-data" action="modificarpartes.php">
...
<input type="hidden" name="cod_elemento" id="cod_elemento" value="<?php 
$cod_elemento=$_REQUEST['cod_elemento'];
echo $cod_elemento?>">
</center>
</form>							  
